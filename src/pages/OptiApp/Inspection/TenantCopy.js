  ...
  return (
    <div className="page-content">
      <div className="mx-2">
        ...
        <Button color="link" outline onClick={BackHome}>
      ...
      <Row className="mb-5 mx-2">
        <Col xl={11} className="mx-auto">
          <Row>
            <img src={livingRoom} alt="living_Room" className="avatar-lg" />
            <Col ls={6}>
              <div>
                <h6>Unit Number</h6>
                <p className="mb-1">012</p>
              </div>
              <div>
                <h6>Property</h6>
                <p className="mb-1">Cosy Studio in the heart of Lagos</p>
              </div>
              <div>
                <h6>Move Inspection Date</h6>
                <p className="mb-1">13th July 2020</p>
              </div>
            </Col>
            <Col ls={6}>
              <div>
