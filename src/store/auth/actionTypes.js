...
export const FETCH_DASHBOARD_SUCCESSFUL = 'FETCH_DASHBOARD_SUCCESSFUL';

export const FETCH_DASHBOARD_API_FAILED = 'FETCH_DASHBOARD_API_FAILED';
...
export const FETCH_PROFILE_API_FAILED = 'FETCH_PROFILE_API_FAILED';
